 ...
 * @property {Partial<User | Patient>} data - The data of the entity (patient or user) on which actions are performed.
 * @property {Route} route - Specifies whether the actions are for 'patients' or 'team' members.
 * @property {boolean} [inInfo] - Optional; if true, the "View details" button is hidden (assumes context where details are already displayed).
 */
type ActionsProps = {
  data: Partial<User | Patient>;
  route: Route;
